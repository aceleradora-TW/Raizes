...
public class ProdutoControlador {
    ...
    @GetMapping("/visualizar-produto-estoque")
    public String vizualizarProdutoEstoque(Breadcrumb breadcrumb) {
        breadcrumb
                .aproveitar(partesComunsDoBreadCrumb)
                .pagina("Produtos", "/produtos")
                .pagina("Produtos em Estoque", "/produtos/visualizar-produto-estoque");

        return "produto/visualizar-produto-estoque";
    }

    @PostMapping("/visualizar-produto-estoque")
    public String visualizarPedido(@PathVariable("id") Long id, Model modelo, Breadcrumb breadcrumb) {
        breadcrumb
                .aproveitar(partesComunsDoBreadCrumb)
                .pagina("Produtos", "/produtos")
                .pagina("Produtos em Estoque", "/pedidos");

        try {

            modelo.addAttribute("pedido", produtoServico.encontraUm(id));
