...
public class InicioControlador {
    ...
    public ResponseEntity criaProdutor() {
        Produtor produtor = new Produtor("ghi@teste.com", "senha", "Ghilherme", "Contato", null, true);
    ...
    public ResponseEntity criaCliente() {
        Cliente cliente = new Cliente("ghi@teste.com", "senha", "Ghilherme", "Contato", null, Collections.emptyList());
